...
> __Observation__: Through some trial an error, it appears that the sample probability converges to the expected probability with 
a greater initial population, rather than more samples of a smaller initial population.
...
t_prob <- .6
trials <- c(0:20)
probabilities <- dbinom(trials, size = 20, prob = t_prob, log = FALSE)
