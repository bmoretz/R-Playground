...
RPROJ <- list(HOME = normalizePath(getwd()), DATA = normalizePath("MSDS401\\data\\"))
data.file.tumor <- paste0(RPROJ$DATA, "tumor.csv")

tumor <- read.csv(file.path(data.file.tumor), sep=",")
