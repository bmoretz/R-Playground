...
cols <- colnames(raw.bootstrap)
data.bootstrap <- raw.bootstrap[, lapply(.SD, function(x) {
    quantile( x, c(.025,.975) ) } ), .SDcols = cols]

q3a_cap <- "MSDS 401: R Programming 2, Q3.b"

# Bootstrap Hist

getValueHist(quartile.bootstrap, "Bootstrap Q", q3a_cap)
