...
The trends in age class is interesting in that A3, A4 and A5 are significantly different from each other in every regard. By this I mean that, A3, A4 and A5 to A1 and A2 all show 
...
similar to any other age class. Also, A3 


```{r question_2a_support}

turkey.class <- as.data.table(cbind(row.names(tukey.results$Class), tukey.results$Class))
colnames(turkey.class) <- c("Class", "diff", "lwr", "upr", "p_adj")

pretty_kable(turkey.class[ p_adj < 0.05], "Tukey Class", dig = 3)
