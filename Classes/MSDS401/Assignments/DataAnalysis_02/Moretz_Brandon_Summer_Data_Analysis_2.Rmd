...
would expect to add an increasingly large negative number as the classes go from A3 -> A5 (A2 is arguably not stastically significant, at a 10% level,
...
Again, I am not an expert in the field of abalone harvesting, however if forced to pick a method from the data observed and the analysis performed, I would
