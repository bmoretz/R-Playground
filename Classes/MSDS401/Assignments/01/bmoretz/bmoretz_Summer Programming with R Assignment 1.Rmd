...
+ Show the location of the __minimum__ value of y determined in __2(b)__.  
...
geom_qqline <- function(data,
    color = "red", line_width = 1, alpha = 1) {
	...
	geom_abline(slope = slope, intercept = int, color = color, lwd = line_width, alpha = alpha )
}
